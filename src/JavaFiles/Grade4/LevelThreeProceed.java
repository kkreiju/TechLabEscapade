 ...
 * @author arjay
 */
public class LevelThreeProceed extends javax.swing.JFrame {

    /**
     * Creates new form LevelThreeProceed
     */
    SoundEffects sfx = new SoundEffects();
    public LevelThreeProceed() {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/4.3proceed.png"))); // NOI18N
    ...
    private void startButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_startButtonMousePressed
        sfx.ClickFX();
        LevelThreePuzzle hi = new LevelThreePuzzle();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelThreeProceed.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelThreeProceed().setVisible(true);
            }
        });
    }
