...
public class LevelFourPageOne extends javax.swing.JFrame {
    ...
    /**
     * Creates new form LevelFourPageOne
     */
    ...
    private void initComponents() {
        ...
        SecondPic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/44pageone2p.png"))); // NOI18N
        ...
        FirstPic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/44pageone1p.png"))); // NOI18N
    ...
    private void FirstPicMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FirstPicMouseEntered
        FirstPic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/44pageone1phover.png")));
    ...
    private void FirstPicMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FirstPicMouseExited
        FirstPic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/44pageone1p.png")));
    ...
    private void FirstPicMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FirstPicMousePressed
        FirstPic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/44pageone1pwrong.png")));
    ...
    private void SecondPicMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SecondPicMouseEntered
        SecondPic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/44pageone2phover.png")));
    ...
    private void SecondPicMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SecondPicMouseExited
        SecondPic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/44pageone2p.png")));
    ...
    private void SecondPicMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SecondPicMousePressed
        SecondPic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/44pageone2pcheck.png")));
