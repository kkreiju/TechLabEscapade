 ...
 * @author VJ
 */
public class LevelTwoPageTwo extends javax.swing.JFrame {
    private Timer timer;
    private int timeleft = 3;
    LevelTwoAnswerPageTwo ltapt = new LevelTwoAnswerPageTwo();
    /**
     * Creates new form LevelTwoPageTwo
     */
    public LevelTwoPageTwo() {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/5leveltwopagetwo.png"))); // NOI18N
    ...
    this.timeleft--;
        if (timeleft < 0) {
            LevelTwoPageThree ltpt = new LevelTwoPageThree();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelTwoPageTwo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelTwoPageTwo().setVisible(true);
            }
        });
    }
