...
public class LevelFourPageThree extends javax.swing.JFrame {
    ...
    LevelFourPageThreeDesc lfptd = new LevelFourPageThreeDesc();
    ...
    private void initComponents() {
        ...
        SecondPicPageOne.setIcon(new javax.swing.ImageIcon(getClass().getResource("/3rdpage2p.png"))); // NOI18N
        ...
        FirstPicPageOne.setIcon(new javax.swing.ImageIcon(getClass().getResource("/3rdpage1p.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/3rdpagebg.png"))); // NOI18N
    ...
    private void SecondPicPageOneMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SecondPicPageOneMouseEntered
        SecondPicPageOne.setIcon(new javax.swing.ImageIcon(getClass().getResource("/3rdpage2phover.png")));
    ...
    private void SecondPicPageOneMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SecondPicPageOneMouseExited
        SecondPicPageOne.setIcon(new javax.swing.ImageIcon(getClass().getResource("/3rdpage2p.png")));
    ...
    private void SecondPicPageOneMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SecondPicPageOneMousePressed
        SecondPicPageOne.setIcon(new javax.swing.ImageIcon(getClass().getResource("/3rdpage2pcheck.png")));
    ...
    private void FirstPicPageOneMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FirstPicPageOneMouseEntered
        FirstPicPageOne.setIcon(new javax.swing.ImageIcon(getClass().getResource("/3rdpage1phover.png")));
    ...
    private void FirstPicPageOneMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FirstPicPageOneMouseExited
        FirstPicPageOne.setIcon(new javax.swing.ImageIcon(getClass().getResource("/3rdpage1p.png")));
    ...
    private void FirstPicPageOneMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FirstPicPageOneMousePressed
        FirstPicPageOne.setIcon(new javax.swing.ImageIcon(getClass().getResource("/3rdpage1pwrong.png")));
    ...
    this.timeleft--;
        if (timeleft < 0) {
            LevelFourPageFour lfpf = new LevelFourPageFour();
            lfpf.setLocationRelativeTo(null);
            lfpf.setResizable(false);
            lfpf.setVisible(true);
            lfptd.dispose();
            this.timeleft = 3;
            timer.stop();
        }
