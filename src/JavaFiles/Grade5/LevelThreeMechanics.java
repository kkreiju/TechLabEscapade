...
public class LevelThreeMechanics extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(NextButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1400, 760, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gradefive_threemechanics.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelThreeMechanics.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelThreeMechanics().setVisible(true);
            }
        });
    }
