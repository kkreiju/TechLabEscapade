 ...
 * @author VJ
 */
public class LevelTwoPageThree extends javax.swing.JFrame {
    private Timer timer;
    ...
    private void initComponents() {
        ...
        getContentPane().add(ThumbsDown, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 560, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/5leveltwopagethree.png"))); // NOI18N
    ...
    this.timeleft--;
        if (timeleft < 0) {
            LevelTwoPageFour LTPF = new LevelTwoPageFour();
            LTPF.setLocationRelativeTo(null);
            LTPF.setResizable(false);
            LTPF.setVisible(true);
            ltpta.dispose();
            this.timeleft = 3;
            timer.stop();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LevelTwoPageThree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LevelTwoPageThree().setVisible(true);
            }
        });
    }
