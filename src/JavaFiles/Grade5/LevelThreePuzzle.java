...
public class LevelThreePuzzle extends javax.swing.JFrame {
    ...
    String[] images = {"excelpuzzle3.png", "excelpuzzle1.png", "excelpuzzle2.png", "excelpuzzle4.png"};
    boolean clicked = false;
    String clickedimage;
    int clickedgrid;
    private Timer timer;
    private int timeleft = 3;
    LevelThreeDisplayExcel ltde = new LevelThreeDisplayExcel();
    ...
    private void ExcelPuzzlePictures(int clickedgrid, int imagesindex, int selectedindex){
        sfx.ClickFX();
        if(!clicked){
            clicked = true;
            if(imagesindex == 0)
    ...
    private void PuzzleVerifier(){
        ...
        if(images[0] == "excelpuzzle1.png" && images[1] == "excelpuzzle2.png" && images[2] == "excelpuzzle3.png" && images[3] == "excelpuzzle4.png")
            correct = true;
        else
            correct = false;
        if(correct){
            ...
            ltde.setLocationRelativeTo(null);
            ltde.setResizable(false);
            ltde.setVisible(true);
            dispose();
            timer.start();
        }    
    }
